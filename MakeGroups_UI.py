...
class Application(tk.Tk):
    ...
    def afficher_logo(self):
        ...
        try:
            ...
            img_labo = Image.open(logo_labo_path).resize((80, 80), Image.Resampling.LANCZOS)
            img_college = Image.open(logo_college_path).resize((80, 80), Image.Resampling.LANCZOS)
